      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Employees Salary details (<?php echo "Today is " . date("d.m.Y") ."."; ?>)</h2>
                       ...
                       while($row = $result->fetch_assoc()) {
                        ...
                        <tr>
						  ...
						  <td class=''>".$row['name']." </td>
                            <td class=''>".$row1['des_name']." </td>
                            <td class=''> ₹".$row5['basic']." </td>
							<td class=''>".$row6['pf_amount']."% </td>
							 <td class=''> ₹".$row5['allowance']." </td>
							  <td class=''> ₹".$row5['conveyance']." </td>
							   <td class=''>".$row0['0']." </td>
							    <td class=''>".$row5['conveyance']." </td>
							   <td class=''> ₹".(round($total,2))." </td>
							   <td class=''><a href='admin_payslip.php?id=".$row['emp_id']."'class='btn btn-info' name='view'>View</a> </td>
							   </tr>
                       </tbody>";
					  }
					    echo "</table>"; 
