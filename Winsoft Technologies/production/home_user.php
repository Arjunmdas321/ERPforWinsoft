      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="tile_count">
            ...
            <div class="col-md-3 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i>  Involved Projects</span>
            ...
            <div class="col-md-4 col-sm-4 ">
              <div class="x_panel tile fixed_height_320">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <div class="x_panel">
                    <div class="x_title">
                      <h2>Your Status <small></small></h2>
                      
                      <div class="clearfix"></div>
                    </div>
							<p> You Are Logged:<h3> <button type="button" class="btn  btn-sm" style= "color:green"> <i class="fa fa-user">
                             </i> IN</i> </button></h3></p><br>
							 <p>Logged in :<strong><?php echo $row['in_time']; ?></strong></p> 
							 <p>Last Session :<strong><?php echo $row['out_time']; ?></strong></p> 
                  ...
                  <div class="x_panel">
					...
					<?php
					     include("connect.php");
						 $mail=$_SESSION['email'];
						 $sql = "SELECT emp_id FROM employee_tbl where email='$mail'";
                                    $result = $connect->query($sql);
									$row = $result->fetch_assoc();
									...
									$id=$row['emp_id'];
									$date=$_POST['date'];
									$ins=mysqli_query($connect,"INSERT INTO `attendance_tbl` (`att_id`, `emp_id`, `att_date`, `attendance`) VALUES (NULL, '$id', '$date', '0')");
									}
						?>
					<form method="post">
                      <h2>Daily Attendance<small></small></h2>
                      
                      <div class="clearfix"></div>
                    </div>
							<p>Pick Date And Enter<h3> 
	             <div class='col-sm-12'>
				...
				<center><button type="submit" name="submit" class="btn btn-primary" >Enter</button></center>
