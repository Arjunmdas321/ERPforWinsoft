        ...
        <div class="right_col" role="main">
          ...
          <?php	include("connect.php");
              ...
              <div class="col-md-12 col-sm-6  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> <h4>Employee Profile</h4> <small></small></h2>
				...
				$mail1=$_GET['id'];
				$sql1 = "SELECT * FROM application where email='$mail1'"; 
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" placeholder="Email" value="<?php echo $row1['email']; ?>" disabled="disabled">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
