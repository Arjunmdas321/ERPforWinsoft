  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
		...
		$sql = "SELECT count(email) FROM application where status='3'"; 
        $result = $connect->query($sql);
		$row = $result->fetch_array();
		
		$sql1 = "SELECT count(email) FROM application where status='3' and gender='Male'"; 
        $result1 = $connect->query($sql1);
		$row1 = $result1->fetch_array();
		
		$sql2 = "SELECT count(email) FROM application where status='3' and gender='Female'"; 
        $result2 = $connect->query($sql2);
		$row2 = $result2->fetch_array();
		
		$sql3 = "SELECT count(email) FROM application where status !='2'"; 
        ...
        <div class="right_col" role="main">
          ...
          <div class="tile_count">
            ...
            <div class="col-md-3 col-sm-4  tile_stats_count">
              ...
              <div class="count green"><?php echo $row1[0];  ?></div>
              
            </div>
            <div class="col-md-3 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-female"></i> Females</span>
              <div class="count"><?php echo $row2[0];  ?></div>
           ...
           <!-- <div class="col-md-2 col-sm-4  tile_stats_count">
            ...
            <div class="col-md-3 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i>Candidates</span>
              <div class="count"><?php echo $row3[0];  ?></div>
